...
export const WEB_HOME_POPULAR_SERVICES = [
  {
    ...services[0],
    id: "web_popular_haircut",
    price: 299,
    image: POPULAR_SERVICE_IMAGES[0],
    title: "Haircut & Styling",
    titleKey: "popularServiceHaircut",
    tagline: "Look your best",
    providerName: "Urban Salon Studio",
    location: "12th Road, Near Linking Road Junction, Bandra West, Mumbai",
  ...
  {
    ...services[1],
    id: "web_popular_massage",
    price: 499,
    image: POPULAR_SERVICE_IMAGES[1],
    title: "Deep Tissue Massage",
    titleKey: "popularServiceMassage",
    tagline: "Relax & rejuvenate",
    providerName: "Serene Spa House",
    location: "80 Feet Road, Koramangala 5th Block, Bengaluru",
    categoryLabel: "Spa",
    reviewCount: 1924,
    badge: "Featured",
    badgeTone: "featured",
  ...
  {
    ...services[2],
    id: "web_popular_dental",
    price: 699,
    image: POPULAR_SERVICE_IMAGES[2],
    title: "Teeth Cleaning",
    titleKey: "popularServiceDental",
    tagline: "Brighten your smile",
    providerName: "Bright Dental Care",
    location: "Block A, Inner Circle, Connaught Place, New Delhi",
  ...
  {
    ...services[3],
    id: "web_popular_training",
    price: 899,
    image: POPULAR_SERVICE_IMAGES[3],
    title: "Personal Training",
    titleKey: "popularServiceTraining",
    tagline: "Fitness & strength",
    providerName: "FitZone Studio",
    location: "Baner Balewadi Road, Near Symbiosis, Pune",
