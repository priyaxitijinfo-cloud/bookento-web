    ...
    (set) => ({
      ...
      toggleService: (serviceId) =>
        set((s) => {
          ...
          if (areServiceIdsEqual(s.draft.serviceIds, ids) && s.draft.packageId === null) {
            return s;
          }
      ...
      setServices: (serviceIds) =>
        set((s) => {
          if (areServiceIdsEqual(s.draft.serviceIds, serviceIds) && s.draft.packageId === null) {
            return s;
          }
      ...
      setPackageId: (packageId) =>
        set((s) => {
          ...
          if (s.draft.packageId === normalizedPackageId && s.draft.serviceIds.length === 0) {
            return s;
          }
          return { draft: { ...s.draft, packageId: normalizedPackageId, serviceIds: [] } };
        }),
      ...
      reset: () => set({ draft: createInitialDraft(), currentStep: 0, isComplete: false }),
    }),
    { name: "BookingStore" },
  ),
);
