...
export default function ProviderChatDetailPage() {
  ...
  const { messages, setActiveConversation, sendMessage, isTyping, isLoading } =
    useChatStore();
      ...
      <main className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="flex-1 space-y-4 overflow-y-auto p-4 lg:p-6">
          {isLoading ? (
            ...
            messages.map((msg) => {
              const isMine =
                msg.senderId === currentProvider.id || msg.senderId === "current_user";
              return (
                <div
                  key={msg.id}
                ...
                >
                  <div
                    className={`max-w-[75%] rounded-2xl px-4 py-2.5 ${
                      isMine ? "gradient-brand text-white" : "bg-muted text-foreground"
                    }`}
                  >
